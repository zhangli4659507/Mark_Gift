...
open class Networking {
     ...
     */
    open func setAuthorizationHeader(_ username: String, password: String) {
     ...
     */
    open func setAuthorizationHeader(_ token: String) {
        self.token = token
    }
     ...
     */
    open func setAuthorizationHeader(_ headerKey: String = "Authorization", headerValue: String) {
    ...
    open func authenticate(_ username: String, password: String) {
        ...
        self.setAuthorizationHeader(username, password: password)
//        self.setAuthorizationHeader(username: username , password: password)
    ...
    open func authenticate(_ token: String) {
    ...
    open func authenticate(_ headerKey: String = "Authorization", headerValue: String) {
        self.setAuthorizationHeader(headerKey, headerValue: headerValue)
//        self.setAuthorizationHeader(headerKey: headerKey, headerValue: headerValue)
     ...
     */
    open func destinationURL(for path: String, cacheName: String? = nil) throws -> URL {
